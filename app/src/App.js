		...
		<div className="account">
			<div className="account__wrapper">
				<div className="account__card">
					...
					/>
					<button type="button" onClick={this.logInUser} className="btn btn-primary account__btn">
						Join
					</button>
				</div>
			</div>
	...
	render() {
		...
		return (
			<React.Fragment>
				...
				<div className="container-fluid">{username ? this.showEditorSection() : this.showLoginSection()}</div>
			</React.Fragment>
		);
	}
}
